...
# url = 'http://127.0.0.1:5000/mechlmm/chat/text'
...
# data = {
#     'question': 'what kind of color is there',
#     'schema': dict_schema,
#     'tag': 'value2',
# }


# url = 'http://127.0.0.1:5000/mechlmm/chat/image'
...
# data = {
#     'question': 'Give me a list of items, return bounding boxes around each object, for each one return [ymin, xmin, ymax, xmax]',
#     'schema': dict_schema,
#     'tag': 'value2',
#     'base_img': image_url
# }
